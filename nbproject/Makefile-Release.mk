...
${OBJECTDIR}/Service/SFController.o: Service/SFController.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I/usr/local/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Service/SFController.o Service/SFController.cpp

${OBJECTDIR}/Service/SFProcessPool.o: Service/SFProcessPool.cpp 
	${MKDIR} -p ${OBJECTDIR}/Service
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I/usr/local/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Service/SFProcessPool.o Service/SFProcessPool.cpp

${OBJECTDIR}/UI/SetFENPopup.o: UI/SetFENPopup.cpp 
	${MKDIR} -p ${OBJECTDIR}/UI
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I/usr/local/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/UI/SetFENPopup.o UI/SetFENPopup.cpp

${OBJECTDIR}/UI/TrainingWidget.o: UI/TrainingWidget.cpp 
	${MKDIR} -p ${OBJECTDIR}/UI
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I/usr/local/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/UI/TrainingWidget.o UI/TrainingWidget.cpp

${OBJECTDIR}/UI/WChessWidget.o: UI/WChessWidget.cpp 
	${MKDIR} -p ${OBJECTDIR}/UI
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I/usr/local/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/UI/WChessWidget.o UI/WChessWidget.cpp
